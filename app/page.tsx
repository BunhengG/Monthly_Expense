...
export default function Home() {
  ...
  const navigateToDetails = (id: string) => {
    router.push(`/pages/view_more_details_page/${id}`);
  };
              ...
              <div>
                <p className="text-sm lg:text-lg md:text-lg">
                  {item.Interpretations.length > 100
                    ? `${item.Interpretations.substring(0, 100)}...`
                    : item.Interpretations}
                </p>
              </div>
              <div className="mt-2 flex gap-2 justify-end items-center md:mt-4 md:gap-4">
                <button
                  ...
                  className="text-sm text-green-500 bg-green-200 px-2 py-1 rounded-md uppercase font-bold tracking-widest md:px-4 md:py-2"
                >
                  More
                </button>
                <button
